        ...
        <Hide below="md">
          <HStack spacing={4} pt={3} mx={5} justify="flex-end">
            <IconButton
              ...
              icon={<SwitchIcon />}
            />
            <Link as={GastbyLink} to="https://github.com/No767/Lavender" style={{ textDecoration: 'none' }}>
              <Button
                variant="outline"
                leftIcon={<SiGithub />}
                borderColor="gray.500"
            ...
            <Menu size="lg">
                <MenuButton as={Button} leftIcon={<BsBook />} borderColor="gray.500" size="lg" variant="outline">
                    Portfolio
                </MenuButton>
                <MenuList>
                    <Link as={GastbyLink} to="/" style={{ textDecoration: 'none' }}>
                    <MenuItem icon={<MdHome/>}>
                        Site Home
                    </MenuItem>
                    </Link>
                    <Link as={GastbyLink} to="/home" style={{ textDecoration: 'none' }}>
                    <MenuItem icon={<MdHome/>}>
                        Portfolio Home
                    </MenuItem>
                    </Link>
                    <Link as={GastbyLink} to="/about" style={{ textDecoration: 'none' }}>
                    <MenuItem icon={<MdOutlineInfo/>}>
                        About
                    </MenuItem>
                    </Link>
                    
                    <Link as={GastbyLink} to="/recipe" style={{ textDecoration: 'none' }}>
                    <MenuItem icon={<BsEggFried/>}>
                        Recipe
                    </MenuItem>
                    </Link>
                    <Link as={GastbyLink} to="/game-lab" style={{ textDecoration: 'none' }}>
                    ...
                    <Link as={GastbyLink} to="/app-lab" style={{ textDecoration: 'none' }}>
