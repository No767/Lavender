    ...
    <>
      ...
      >
        ...
        <Text size="lg" align="center">
          ...
          functions in order to do it. It isn't the best, but does the job. It's
          supposed to be someone with cat ears, but I messed up on the ears
        </Text>
      </Stack>
      <Stack
        align="center"
      ...
      >
        ...
        />
        <Text size="lg" align="center">
          It's supposed to be a snake but it kinda moves. This one wasn't as
          hard to add, compared to the other ones. It uses the randomNumber
