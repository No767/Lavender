...
export function Body({}) {
  return <><Title align="center" sx={{
      color: "#F8F9FA",
      paddingTop: 120
    }}>Lavender</Title>
        <Title order={2} align="center" x={{
      color: "#FFFFFF",
      paddingTop: 35
    }}>The Digital Portfolio for CS</Title>
        <Divider size="sm" sx={{
      marginTop: 100
    }} />
      ...
      paddingTop: 50,
      paddingBottom: 100
    }}>So, what are the features of this collection of mini projects?</Title>

        <Group position="center" direction="column" spacing="md">
          <MdBolt className="iconSize" />
          <Title order={2} align="center" sx={{
        color: "#F8F9FA"
      }}>Built For Performance</Title>
          <Text size="xl" align="center" color="white" sx={{
        paddingBottom: 150
      }}>
        ...
        <Group position="center" direction="column" spacing="md">
          ...
          <Title order={2} align="center" sx={{
        color: "#F8F9FA"
      }}>A Wide Collection of Websites</Title>
          <Text size="xl" align="center" color="white" sx={{
        paddingBottom: 150
      }}>
