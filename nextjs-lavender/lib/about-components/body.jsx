        ...
        <>
            <Stack align="center" justify="center" spacing="lg">
                ...
                <Text size="lg" color="white" align="center" mx={200} pb={25}>
                    ...
                    work with frameworks like React, Next.js, and Remix, to
                    backend frameworks like FastAPI. In fact, this whole entire
                    website has been written using Next.js and Mantine
                </Text>
            </Stack>
                ...
                <Stack align="center" justify="center" spacing="lg">
                    ...
                    <Stack align="center" justify="center" spacing="lg" px={50}>
                        ...
                        <Text size="lg" color="white" align="center" pb={75}>
                            The Multipurpose Version of Rin - Supports
                            Moderation, Economy, and much much more
                        </Text>
                    </Stack>
                </Stack>
            </Stack>
